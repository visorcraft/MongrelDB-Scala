...
```scala
libraryDependencies += "com.visorcraft" %% "mongreldb-scala" % "0.59.1"
```

### scala-cli

```scala
//> using dep com.visorcraft::mongreldb-scala:0.59.1
```
...
val db = NativeDB.create("/path/to/dbdir", schemaJson)
try
